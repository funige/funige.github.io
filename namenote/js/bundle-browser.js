    ...
    value: function preventScrollFreeze() {
      ...
      scroller.on('touchmove', function (e) {
        ...
        if (window.fixScroll && scrollTop === 0 && direction === "up") {
          ...
          log('prevent up');
          e.preventDefault();
        } else if (window.fixScroll && scrollTop >= e.currentTarget.scrollHeight - e.target.offsetHeight && direction === "down") {
